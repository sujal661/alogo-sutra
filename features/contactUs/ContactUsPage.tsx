...
>(({ className = "", ...props }, ref) => (
  <input
    ref={ref}
    className={`w-full px-4 py-3 border border-[#606060] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 outline-none ${className}`}
    {...props}
  />
));
...
>(({ className = "", children, ...props }, ref) => (
  <select
    ref={ref}
    className={`w-full px-4 py-3 border border-[#606060] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 outline-none appearance-none bg-white ${className}`}
    {...props}
  >
    {children}
  </select>
...
>(({ className = "", ...props }, ref) => (
  <textarea
    ref={ref}
    className={`w-full px-4 py-3 border border-[#606060] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 outline-none resize-none ${className}`}
    {...props}
  />
));
...
export default function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen pt-30  bg-[#F0F0F0] py-8 px-4 sm:px-6 lg:px-8">
      <ScrollAnimate>
        <div className=" mx-auto flex justify-start flex-col  md:items-center ">
          {/* Header */}
          <div
            className={`text-center ${poppins.className} mb-8 z-50 sm:mb-12 animate-in fade-in slide-in-from-top-4 duration-700`}
          >
            ...
            <p className="sm:text-[18px] font-normal text-[#161616] text-base mt-10  md:px-40">
              Whether you want to learn algo trading, explore strategies,
              automate your own idea, or just general enquiry, our team is happy
          ...
          <div className="bg-white z-50 rounded-2xl lg:w-4xl shadow-xl  p-6 sm:p-8 lg:p-10 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
            <p
              className={`text-center ${inter.className} font-normal  text-[17px] text-gray-700 mb-8`}
            >
              We'd love to hear from you. Fill out the form below and we'll
              reach out to you in 48hrs.
            </p>

            <div
              className={` ${poppins.className} font-medium space-y-6 text-[#1C4245] text-[14px] md:text-[18px]`}
            >
              {/* Name Field */}
              <FormField>
              ...
              <FormField>
                ...
                <Input
                  ...
                  className={
                    errors.email
                      ? `border-red-500 placeholder:${inter.className}  `
              ...
              {/* Product Field */}
              <FormField>
                <FormLabel error={!!errors.product}>
                  <p className="text-[16px] md:text-[20px]">Product</p>
                </FormLabel>
                <div className="relative">
                  <Select
                    ...
                    className={
                      errors.product
                        ? "border-red-500 placeholder:text-[#1C4245]"
                        : " placeholder:text-[#1C4245]"
                    }
                  >
                    <option
                      className="text-[#1C4245] text-[14px] md:text-[18px]"
                      value=""
                    >
                      Select Product
                    </option>
              ...
              {/* Message Field */}
              <FormField>
                <FormLabel error={!!errors.message}>
                  <p className="text-[16px] md:text-[20px]">Message</p>
                </FormLabel>
                <Textarea
                  {...register("message")}
    ...
    text-base sm:text-[14px] md:text-[16px] h-[50%] rounded-full md:px-6 md:py-[13px]  "
                >
                  {isSubmitting ? (
                    <span className="flex items-center justify-center">
                      <svg
      ...
      <ScrollAnimate>
        <div className=" w-full flex justify-center ">
          <div className=" w-full bg-[#1A73E8] rounded-[20px] shadow-xl p-6 sm:p-8 lg:p-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
            <h2
              className={`text-[32px] justify-start px-8 sm:text-3xl font-normal md:text-[32px] ${poppins.className} text-white md:text-center mb-8`}
            >
              Contact Information
            </h2>

            <div
              className={`md:grid md:grid-cols-1 ${poppins.className} flex-col items-center  justify-center md:grid-cols-3 md:px-7 gap-1 lg:gap-2`}
            >
              {/* Office Address */}
              <div className="flex mb-4  flex-row items-start justify-start md:justify-center gap-4  group">
                <div className="px-2 rounded-full mb-4  transition-all duration-300 ">
                ...
                <div>
                  ...
                  <p
                    className={`${inter.className} text-blue-100 md:text-[18px] `}
                  >
