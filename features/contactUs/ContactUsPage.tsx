...
// Form Components
const FormField = ({ children }: { children: React.ReactNode }) => <div className="space-y-2">{children}</div>;

const FormLabel = ({ children, error }: { children: React.ReactNode; error?: boolean }) => (
  <label className={`block text-2xl font-medium ${error ? "text-red-500" : "text-gray-700"}`}>
    {children}
  </label>
);

const FormMessage = ({ children }: { children?: React.ReactNode }) => (
  children ? <p className="text-sm text-red-500 mt-1 animate-in fade-in slide-in-from-top-1 duration-200">{children}</p> : null
);
...
export default function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen pt-30  bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-8 sm:mb-12 animate-in fade-in slide-in-from-top-4 duration-700">
          <p className="text-4xl sm:text-6xl lg:text-9xl font-normal text-gray-900 mb-4">
            Contact AlgoSutraa
          </p>
          <p className="sm:text-2xl font-bold text-gray-600 text-base mt-10 mx-auto px-4">
            Whether you want to learn algo trading, explore strategies, automate your own idea, or just general
            enquiry, our team is happy to help you find the right path.
          </p>
        </div>

        {/* Form Card */}
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 lg:p-10 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
          <p className="text-center text-2xl text-gray-700 mb-8">
            We'd love to hear from you. Fill out the form below and we'll reach out to you in 48hrs.
          </p>
          ...
          <div className="space-y-6 text-2xl">
            ...
            {/* Product Field */}
            <FormField>
              <FormLabel error={!!errors.product}>Product</FormLabel>
              <div className="relative">
                ...
                >
                  ...
                  <option value="algo-trading-course">Algo Trading Course</option>
            ...
            {/* Message Field */}
            <FormField>
              <FormLabel error={!!errors.message}>Message</FormLabel>
              <Textarea
                {...register("message")}
...
<div className="w-full flex justify-center text-2xl ">
    ...
    <div className=" w-full flex justify-center ">
        ...
        <div className=" w-[80%] bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-xl p-6 sm:p-8 lg:p-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="bg-white/10 p-4 rounded-full mb-4 group-hover:bg-white/20 transition-all duration-300 group-hover:scale-110">
                <MapPin className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Office Address</h3>
              <p className="text-blue-100 text-sm leading-relaxed">
                Al Marzouqi Building, Office No. 214, Al Goze<br />
